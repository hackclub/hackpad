...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        MIDI_CC80, QK_MIDI_NOTE_C_0, QK_MIDI_MIDI_NOTE_C_1, QK_MIDI_NOTE_C_2, QK_MIDI_NOTE_C_3, QK_MIDI_NOTE_C_4, QK_MIDI_NOTE_D_0, QK_MIDI_NOTE_E_0, QK_MIDI_NOTE_F_0, QK_MIDI_NOTE_G_0, QK_MIDI_NOTE_A_0, QK_MIDI_NOTE_B_0 QK_MIDI_OCTAVE_UP, QK_MIDI_OCTAVE_DOWN, QK_MIDI_TOGGLE,
