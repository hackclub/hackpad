...
NEOPIXEL_PIN = board.GP1  # ist pin to send dta to leds
...
# here are the gaming keys for gamepad lets hope thses will be what is needed
KC_GAME_1 = KC.W
KC_GAME_2 = KC.A
KC_GAME_3 = KC.S
...
def set_neopixel_color(color):
    for i in range(9):  # 9 Neopixels i used hpe theyll run i added capicitor(100uf) lets see
