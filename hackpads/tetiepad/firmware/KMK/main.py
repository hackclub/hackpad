...
layer0 = kmk.Layer([
    KC.KEY_1, KC.KEY_2, KC.KEY_3, KC.KEY_4, KC.KEY_5, KC.KEY_6,
])
layer1 = kmk.Layer([
    KC.KEY_Q, KC.KEY_W, KC.KEY_E, KC.KEY_R, KC.KEY_T, KC.KEY_Y,
])
layer2 = kmk.Layer([
    KC.KEY_U, KC.KEY_I, KC.KEY_O, KC.KEY_P, KC.LBRC, KC.RBRC,
])
...
encoder_handler.pins = ((pins[7], pins[8], pins[9], False),) # encoder_A, encoder_B, push, invert
