...
<img src="examplelayout.png" className="max-w-xl" />
...
If everything went correctly, your PR will be reviewed (and hopefully approved!) by @alexren. After that, you'll get your parts shipped to you!
