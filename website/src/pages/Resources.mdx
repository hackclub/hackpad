...
Beyond this though, Google is an infinite resource that is only bounded by your own ability to use it!
...
- You can almost always find the footprint/symbol you're looking for if you use [SnapEDA](https://www.snapeda.com/) or similar. Google is your best friend
