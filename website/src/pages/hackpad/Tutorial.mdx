...
Next, create a sketch by by pressing the green + button on the top left, then clicking the bottom orange retangle at the center of the screen. Create a rectangle that is 0.5mm bigger than your hackpad's PCB. For example, my PCB is 41mm x 62.7mm, I added 0.5mm to each on the sketch.
