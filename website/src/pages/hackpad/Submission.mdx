...
*PSA: You can only do hackpad once! If you already got a hackpad kit, you're not eligible to get a second*
...
**Check that your project to make sure your project follows the [approved parts](/parts) list!** Your project will be returned if it doesn't D:
...
Next, you should make a ship post in #hackpad-ships on slack! Here's an example for my own macropad:
...
- A [Hackpad kit](/parts) with all the parts you need to build your hackpad!
- A $10 Card grant to buy your PCB from JLCPCB
- A $5 Card grant to get a 3D printed case from another Hack Clubber via [Printing Legion](https://printlegion.hackclub.com)
- A $18 Card grant to buy a soldering iron, if needed!

This will get sent in your email! Make sure you pick the right one
